...
public class DisplayBookDetailsSteps extends ScenarioSteps {
    ...
    public void validateBookDetailsDisplayed() {
        boolean areDetailsDisplayed = displayBookDetails.validatedetailsBooks();
        Assertions.assertThat(areDetailsDisplayed).isTrue().withFailMessage("Book details are not displayed");
    }
}
