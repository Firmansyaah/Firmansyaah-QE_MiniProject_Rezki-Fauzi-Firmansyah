...
public class EditBookPageSteps extends ScenarioSteps {
    ...
    public void iShouldSeeASuccessMessageIndicatingTheBookHasBeenEditedSuccessfully() {
        boolean isSuccessMessageDisplayed = editBookPage.isSuccessMessageDisplayed();
        Assertions.assertTrue(isSuccessMessageDisplayed, "Success message is not displayed");
    }
    ...
    public void verifyFailureMessageDisplayed() {
        boolean isFailureMessageDisplayed = editBookPage.isFailureMessageDisplayed();
        Assertions.assertTrue(isFailureMessageDisplayed, "Failure message is not displayed");
    }
}
